...
/**
 * The TypeUtil class static methods for inspecting complex java types. The
 * typeToString() method is used to dump the contents of a passed object of any
 * type (or collection) to a String. This can be very useful for debugging code
 * that manipulates complex structures.
 *
 * @version $Revision : 1.2.6.4 $
 */

public class TypeUtil {
    private static String complexTypeToString(String scope, Object parentObject, List<Object> visitedObjs) {
    ...
    private static void processFields(Field[] fields, String scope, Object parentObject, StringBuffer buffer, List<Object> visitedObjs) throws IllegalAccessException {
        for (int i = 0; i < fields.length; i++) {
            ...
            if (Modifier.isStatic(fields[i].getModifiers())) {
                ...
                // is
                // meant to impl are simple data objects, so static members
                // have no
                // bearing....
                //
            } else {
    ...
    public static boolean isCollectionType(Object obj) {
        ...
        return (
                obj.getClass().isArray() || (obj instanceof Collection) || (obj instanceof Hashtable) || (obj instanceof HashMap) || (obj instanceof HashSet) || (obj instanceof List) || (obj instanceof AbstractMap)
        );
    }
    ...
    public static boolean isComplexType(Object obj) {
        ...
        if (obj instanceof Boolean || obj instanceof Short || obj instanceof Byte || obj instanceof Integer || obj instanceof Long || obj instanceof Float || obj instanceof Character || obj instanceof Double || obj instanceof String) {
    ...
    private static String collectionTypeToString(String scope, Object obj, List<Object> visitedObjs) {
        StringBuffer buffer = new StringBuffer("");
