 ...
 */
@Sharable
public class GameMessageEncoder extends MessageToByteEncoder<Object> {
    
    private final MessageRegistry registry;

    public GameMessageEncoder(MessageRegistry registry) {
    ...
    protected void encode(ChannelHandlerContext chc, Object msg, ByteBuf bb) throws Exception {
        ...
        bb.writeShort(0);//没有getUnsignedShort
        
        // 消息数据
        ((MessageLite) msg).writeTo(new ByteBufOutputStream(bb));
        
        // 补上后续长度
        int bodyLength = bb.writerIndex() - bodyLengthIdx - 2;
        // todo 检查消息长度是否太长（>65535）
        bb.setShort(bodyLengthIdx, bodyLength);
    }
